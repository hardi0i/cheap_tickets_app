...
class _OffersRemoteDataSource implements OffersRemoteDataSource {
  ...
  @override
  Future<HttpResponse<OffersWrapperModel>> getOffers() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<OffersWrapperModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = OffersWrapperModel.fromJson(_result.data!);
